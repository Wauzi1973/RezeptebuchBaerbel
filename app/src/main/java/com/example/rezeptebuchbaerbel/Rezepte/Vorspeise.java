...
public class Vorspeise {
    ...
    public ArrayList<RoomRezepte> Vorspeise(){
        ...
        listRezepteVorspeise.add(listRezepteVorspeise.size(),new RoomRezepte("Aioli",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
...
/*
        ...
        listRezepteSonstiges = "";
        listRezepteVorspeise.add(listRezepteVorspeise.size(),new RoomRezepte("Name",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
