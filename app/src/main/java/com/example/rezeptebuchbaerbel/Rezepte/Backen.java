...
public class Backen {
    ...
    public ArrayList<RoomRezepte> Backen(){
        ...
        listRezepteBacken.add(listRezepteBacken.size(),new RoomRezepte("Orangenplätzchen",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));

        listRezepteZutaten = "375 g Mehl  \n 125 g Zucker  \n 125 g Butter   \n 0.25 Päckchen Backpulver   \n 1.5 Päckchen Vanillezucker  \n 0.25 L Milch   \n 3 Stück Eier  \n";
        listRezepteAnweisungen = "Alles vermanschen. \n Backen. \n Und futtern.  \n";
        listRezepteSonstiges = "";
        listRezepteBacken.add(listRezepteBacken.size(),new RoomRezepte("Waffeln",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSonstiges = "";
        listRezepteBacken.add(listRezepteBacken.size(),new RoomRezepte("Pfannkuchen",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
...
/*
        ...
        listRezepteSonstiges = "";
        listRezepteBacken.add(listRezepteBacken.size(),new RoomRezepte("Name",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
