...
public class BrotaufstrichRezepte {
    ArrayList<RezepteArray> listRezepteBrotaufstrich = new ArrayList<RezepteArray>();
    ...
    public ArrayList<RezepteArray> Brotaufstrich(){
        ...
        listRezepteBrotaufstrich.add(listRezepteBrotaufstrich.size(),new RezepteArray(listRezepteName,listBild,listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
