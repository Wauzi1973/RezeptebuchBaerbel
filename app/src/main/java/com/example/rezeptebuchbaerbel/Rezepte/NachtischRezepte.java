...
public class NachtischRezepte {
    ArrayList<RezepteArray> listRezepteNachtisch = new ArrayList<RezepteArray>();
    ...
    public ArrayList<RezepteArray> Nachtisch(){
        ...
        listRezepteNachtisch.add(listRezepteNachtisch.size(),new RezepteArray(listRezepteName,listBild,listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
