...
public class Kuchen {
    ...
    public ArrayList<RoomRezepte> Kuchen(){
        listRezepteName = "Vanille Erdbeer Torte";
        ...
        listRezepteKuchen.add(listRezepteKuchen.size(),new RoomRezepte(listRezepteName,listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));

        listRezepteName = "Edle Buttercremetorte";
        ...
        listRezepteName = "Patchwork Kuchen";
