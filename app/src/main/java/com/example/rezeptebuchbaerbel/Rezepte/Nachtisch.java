...
public class Nachtisch {
    ...
    public ArrayList<RoomRezepte> Nachtisch(){
        ...
        listRezepteNachtisch.add(listRezepteNachtisch.size(),new RoomRezepte("Mascarpone Himbeerquark",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteNachtisch.add(listRezepteNachtisch.size(),new RoomRezepte("Spekulatius Creme",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
...
/*
        ...
        listRezepteSonstiges = "";
        listRezepteNachtisch.add(listRezepteNachtisch.size(),new RoomRezepte("Name",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
