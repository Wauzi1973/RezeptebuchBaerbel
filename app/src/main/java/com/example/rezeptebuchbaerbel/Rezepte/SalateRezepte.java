...
public class SalateRezepte {
    ArrayList<RezepteArray> listRezepteSalate = new ArrayList<RezepteArray>();
    ...
    public ArrayList<RezepteArray> Salate(){
        ...
        listRezepteSalate.add(listRezepteSalate.size(),new RezepteArray(listRezepteName,listBild,listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
