...
public class SmoothieRezepte {
    ArrayList<RezepteArray> listRezepteSmoothie =new ArrayList<RezepteArray>();
    ...
    public ArrayList<RezepteArray> Smoothie(){

        listRezepteName = "Erdbeer Himbeer Smoothie";
        ...
        listRezepteSmoothie.add(listRezepteSmoothie.size(),new RezepteArray(listRezepteName,listBild,listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));

        listRezepteName = "Erdbeer Smoothie";
        listBild = R.drawable.icon_logo;
        ...
        listRezepteName = "Roter Smoothie";
        listBild = R.drawable.icon_logo;
        ...
        listRezepteName = "Gelber Smoothie";
        listBild = R.drawable.icon_logo;
        ...
        listRezepteName = "Bananen Milchshake";
        listBild = R.drawable.icon_logo;
