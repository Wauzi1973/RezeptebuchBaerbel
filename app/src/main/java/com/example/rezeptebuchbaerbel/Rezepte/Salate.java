...
public class Salate {
    ...
    public ArrayList<RoomRezepte> Salate(){
        ...
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Frühlingssalat mit Ei",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Mailänder Salat",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSonstiges = "";
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Fruchtiger Nudelsalat",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSonstiges = "";
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Nudelsalat",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSonstiges = "";
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte( "Tortellinisalat komplett",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Eier Chamgignon Salat",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Paprika Reis Salat mit Kräuterdressing",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSonstiges = "";
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Spargel Nudelsalat mit Käse",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
        ...
        listRezepteSonstiges = "";
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Nachosalat",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
...
/*
        ...
        listRezepteSonstiges = "";
        listRezepteSalate.add(listRezepteSalate.size(),new RoomRezepte("Name",listRezepteZutaten,listRezepteAnweisungen,listRezepteSonstiges));
